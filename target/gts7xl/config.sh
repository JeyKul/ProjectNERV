...
# Device configuration file for Galaxy Tab S7+ (LTE/5G) (gts7xl)
TARGET_NAME="Galaxy Tab S7+ (LTE/5G)"
TARGET_CODENAME="gts7xl"
TARGET_ASSERT_MODEL=("SM-T976B")
TARGET_FIRMWARE="SM-T976B/BTU/356412111301765"
TARGET_EXTRA_FIRMWARES=()
TARGET_API_LEVEL=33
TARGET_PRODUCT_FIRST_API_LEVEL=30
TARGET_VENDOR_API_LEVEL=30
TARGET_SINGLE_SYSTEM_IMAGE="gts9p"
