...
SEC_FLOATING_FEATURE_LCD_CONFIG_HW_MDNIE=
...
SEC_FLOATING_FEATURE_LCD_SUPPORT_SCREEN_MODE_TYPE=1
SEC_FLOATING_FEATURE_LCD_CONFIG_SELFMASK_VERSION=0
SEC_FLOATING_FEATURE_LCD_SUPPORT_BLUE_FILTER_FOR_TFT=
